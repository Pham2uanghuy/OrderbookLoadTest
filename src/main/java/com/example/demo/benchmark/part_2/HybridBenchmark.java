package com.example.demo.benchmark.part_2;
...
import com.example.demo.impl.hybrid.HybridOrderBookIncremental;
...
public class HybridBenchmark {
    ...
    public static void main(String[] args) {
        ...
        for (int loadSize : loadSizes) {
            ...
            benchmarkOrderBook("ArrayDequeOrderBook_SMALL_CLUSTERED",
                    new ArrayDequeOrderBook(), loadSize, 20000, 30000, btcPriceStep, "clustered");
            benchmarkOrderBook("StaticArrayOrderBook_SMALL_CLUSTERED",
                    new StaticArrayOrderBook(20000, 30000, btcPriceStep), loadSize, 20000, 30000, btcPriceStep, "clustered");
            benchmarkOrderBook("HybridOrderBookIncremental_SMALL_CLUSTERED",
                    new HybridOrderBookIncremental(20000, 30000, btcPriceStep, 50), loadSize, 20000, 30000, btcPriceStep, "clustered");

            // Scenario B: small range, spread
            System.out.println(">>> Scenario B: Small price range (~10k prices), orders spread out");
            benchmarkOrderBook("ArrayDequeOrderBook_SMALL_SPREAD",
                    new ArrayDequeOrderBook(), loadSize, 20000, 30000, btcPriceStep, "spread");
            benchmarkOrderBook("StaticArrayOrderBook_SMALL_SPREAD",
                    new StaticArrayOrderBook(20000, 30000, btcPriceStep), loadSize, 20000, 30000, btcPriceStep, "spread");
            benchmarkOrderBook("HybridOrderBookIncremental_SMALL_SPREAD",
                    new HybridOrderBookIncremental(20000, 30000, btcPriceStep, 50), loadSize, 20000, 30000, btcPriceStep, "spread");
            ...
            benchmarkOrderBook("ArrayDequeOrderBook_LARGE_CLUSTERED",
                    new ArrayDequeOrderBook(), loadSize, 1000, 1_001_000, btcPriceStep, "clustered");
            benchmarkOrderBook("StaticArrayOrderBook_LARGE_CLUSTERED",
                    new StaticArrayOrderBook(1000, 1_001_000, btcPriceStep), loadSize, 1000, 1_001_000, btcPriceStep, "clustered");
            benchmarkOrderBook("HybridOrderBookIncremental_LARGE_CLUSTERED",
                    new HybridOrderBookIncremental(1000, 1_001_000, btcPriceStep, 50), loadSize, 1000, 1_001_000, btcPriceStep, "clustered");

            // Scenario D: large range, spread
            System.out.println(">>> Scenario D: Large price range (~1M prices), orders spread out");
            benchmarkOrderBook("ArrayDequeOrderBook_LARGE_SPREAD",
                    new ArrayDequeOrderBook(), loadSize, 1000, 1_001_000, btcPriceStep, "spread");
            benchmarkOrderBook("StaticArrayOrderBook_LARGE_SPREAD",
                    new StaticArrayOrderBook(1000, 1_001_000, btcPriceStep), loadSize, 1000, 1_001_000, btcPriceStep, "spread");
            benchmarkOrderBook("HybridOrderBookIncremental_LARGE_SPREAD",
                    new HybridOrderBookIncremental(1000, 1_001_000, btcPriceStep, 50), loadSize, 1000, 1_001_000, btcPriceStep, "spread");
        }
    }
