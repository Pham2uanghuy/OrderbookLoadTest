...
//            benchmarkOrderBook("OriginalOrderBook", new OriginalOrderBook(), loadSize);
//            benchmarkOrderBook("ConcurrentOrderBook", new ConcurrentOrderBook(), loadSize);
            benchmarkOrderBook("ArrayDequeOrderBook", new ArrayDequeOrderBook(), loadSize);
            benchmarkOrderBook("LongObjectArrayDequeOrderBook", new ArrayDequeOrderBook(), loadSize);
//         benchmarkOrderBook("ConcurrentArrayDequeOrderBook", new ConcurrentArrayDequeOrderBook(), loadSize);
        }
    }
    ...
    private static void benchmarkOrderBook(String name, OrderBook orderBook, int loadSize) {
        ...
        PrimitiveOrder[] orders = preGenerateOrders(loadSize);
    ...
    private static PrimitiveOrder[] preGenerateOrders(int loadSize) {
